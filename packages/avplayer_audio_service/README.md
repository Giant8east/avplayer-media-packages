...
- Bundles default media notification vector drawables (`ic_notification_favorite`, `ic_notification_favorite_border`, `ic_notif_prev_outline`, `ic_notif_play_outline`, `ic_notif_pause_outline`, `ic_notif_next_outline`, `ic_notif_placeholder`, `ic_default_artwork`).
...
```yaml
dependencies:
  avplayer_audio_service: ^0.18.19+2
```
